                            ...
                            <form action="{{ route('recherche') }}" method="GET">
                                <div class="form-group d-flex">
                                    ...
                                    <select name="type" class="form-control ms-3" id="exampleSelectGender">
                                        ...
                                        <option value="agricole">Coopératives agricoles</option>
                                ...
                                @isset ($results)
                                    @forelse ($results as $result)
                                        <div class="pt-4 border-bottom">
                                            <a class="d-block h4" href="#">{{ $result->nom }}</a>
                                            Dans <a class="page-url text-primary" href="#">{{ Request::get('type') }}</a>
                                    ...
                                    @empty
                                        <h4>Votre terme de recherche ne correspond à aucune de nos données dans la catégorie: "<b>{{ Request::get('type') }}</b>"</h4>
                                    @endforelse
