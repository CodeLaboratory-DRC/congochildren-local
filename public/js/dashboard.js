...
function stepArea(stats) {

  var max = maxValue(stats);
  return (max < 10) ? 1 : ((max > 10 && max < 100) ? 10 : ((max > 1000 && max < 10000) ? 500 : 1000) )
}

function maxValue(stats) {
  return Math.max.apply(Math,stats)
}
...
(function($) {
  ...
  $(function() {
    ...
    if ($("#order-chart").length) {
      ...
      // console.log(Math.max.apply(Math,stats));
      var areaOptions = {
        responsive: true,
        ...
        scales: {
          ...
          yAxes: [{
            ...
            ticks: {
              ...
              autoSkip: false,
              maxRotation: 0,
              stepSize: stepArea(stats),
              min: 0,
              max: (maxValue(stats) < 100) ? 10 : maxValue(stats),
              padding: 18,
              fontColor:"#6C7383"
            },
            gridLines: {
    ...
    if ($("#province-chart").length) {
      ...
      var revenueChartCanvas = $("#province-chart").get(0).getContext("2d");
      var revenueChart = new Chart(revenueChartCanvas, {
        type: 'line',
        data: areaData,
        options: areaOptions
    ...
    if ($("#north-america-chart").length) {
      var areaData = {
        labels: ["Moins de 14", "14 - 18 ans", "Plus de 18 ans"],
        datasets: [{
            data: [tranche1, tranche2, tranche3],
            backgroundColor: [
      ...
      var areaOptions = {
        ...
        legendCallback: function(chart) { 
          ...
          text.push('<div class="report-chart">');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="me-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[0] + '"></div><p class="mb-0">Moins de 14</p></div>');
            text.push('<p class="mb-0">'+tranche1+'</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="me-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[1] + '"></div><p class="mb-0">14 - 18 ans</p></div>');
            text.push('<p class="mb-0">'+tranche2+'</p>');
            text.push('</div>');
            text.push('<div class="d-flex justify-content-between mx-4 mx-xl-5 mt-3"><div class="d-flex align-items-center"><div class="me-3" style="width:20px; height:20px; border-radius: 50%; background-color: ' + chart.data.datasets[0].backgroundColor[2] + '"></div><p class="mb-0">Plus de 18 ans</p></div>');
            text.push('<p class="mb-0">'+tranche3+'</p>');
            text.push('</div>');
          text.push('</div>');
          return text.join("");
        },
      ...
      var northAmericaChartPlugins = {
        beforeDraw: function(chart) {
          ...
          var text = Math.max(tranche1,tranche2,tranche3),
    ...
    if ($("#north-america-chart-province").length) {
      var areaData = {
        labels: ["Moins de 14", "14 - 18 ans", "Plus de 18 ans"],
        datasets: [{
            data: [tranche1, tranche2, tranche3],
      ...
      var northAmericaChartCanvas = $("#north-america-chart-province").get(0).getContext("2d");
      var northAmericaChart = new Chart(northAmericaChartCanvas, {
        type: 'doughnut',
        data: areaData,
        options: areaOptions,
      ...
      document.getElementById('north-america-legend-province').innerHTML = northAmericaChart.generateLegend();
    }
